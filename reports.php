...
<div class="card w-100" style="border:none;box-shadow:none;background:none;">
    <div class="card-header" style="background:none;border:none;padding-left:0;">
            ...
            <div class="container-fluid mt-4">
                <div class="row mb-4">
                    ...
                    <div class="col text-end">
                        <button onclick="exportTableToExcel('myTable', 'Vedomost')" class="btn btn-success">
                ...
                <div class="table-responsive p-0" style="width:100%;">
                    <table id="myTable" class="table table-striped w-100" style="width:100%;">
                        <thead>
                            <tr>
                                <th>Стейдж</th> 
                        ...
                        <tbody>
                            <?php foreach ($results as $user): ?>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    ">
                                    <?php echo htmlspecialchars($user['login']); ?></td>
                                    <?php if ($_SESSION['role'] === 'admin'): ?>
                                        <td>
